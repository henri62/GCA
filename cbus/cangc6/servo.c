...
void reportServoPosition(byte rightSide) {
    ...
    canmsg.b[d0] = rightSide ? OPC_ASOF : OPC_ASON;
    canmsg.b[d1] = (NN_temp / 256) & 0xFF;
    canmsg.b[d2] = (NN_temp % 256) & 0xFF;
    canmsg.b[d3] = (Servo[servoIdx].fbaddr / 256) & 0xFF;
    canmsg.b[d4] = (Servo[servoIdx].fbaddr % 256) & 0xFF;
...
byte readExtSensors(byte servo) {
    ...
    canmsg.b[d0] = !thrown ? OPC_ASON : OPC_ASOF;
    canmsg.b[d1] = (NN_temp / 256) & 0xFF;
    canmsg.b[d2] = (NN_temp % 256) & 0xFF;
    canmsg.b[d3] = (Servo[servo].fbaddr / 256) & 0xFF;
    canmsg.b[d4] = (Servo[servo].fbaddr % 256) & 0xFF;
    canmsg.b[dlc] = 5; // data bytes
    canbusSend(&canmsg);
