...
#define EE_SERVO_SPEEDL EE_SERVO_RIGHT+4
#define EE_SERVO_POSITION EE_SERVO_SPEEDL+4
#define EE_SERVO_FBADDR EE_SERVO_POSITION+4
#define EE_SERVO_SWADDR EE_SERVO_FBADDR+8
#define EE_SERVO_SWNN EE_SERVO_SWADDR+8
#define EE_SERVO_SPEEDR EE_SERVO_SWNN+8
