...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
.PHONY: ${OBJECTDIR}/canrs.o
${OBJECTDIR}/canrs.o: canrs.asm __revgrep__ nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	-${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_PK3=1 -q -p$(MP_PROCESSOR_OPTION)  -l"${OBJECTDIR}/canrs.lst" -e"${OBJECTDIR}/canrs.err" $(ASM_OPTIONS) -o"${OBJECTDIR}/canrs.o" canrs.asm 
else 
	-${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_PK3=1 -q -p$(MP_PROCESSOR_OPTION) -u  -l"${OBJECTDIR}/canrs.lst" -e"${OBJECTDIR}/canrs.err" $(ASM_OPTIONS) -o"${OBJECTDIR}/canrs.o" canrs.asm 
endif 
	@cat  "${OBJECTDIR}/canrs.err" | sed -e 's/\x0D$$//' -e 's/\(^Warning\|^Error\|^Message\)\(\[[0-9]*\]\) *\(.*\) \([0-9]*\) : \(.*$$\)/\3:\4: \1\2: \5/g'
	@./__revgrep__ "^Error" ${OBJECTDIR}/canrs.err
else
.PHONY: ${OBJECTDIR}/canrs.o
${OBJECTDIR}/canrs.o: canrs.asm __revgrep__ nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	-${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION)  -l"${OBJECTDIR}/canrs.lst" -e"${OBJECTDIR}/canrs.err" $(ASM_OPTIONS) -o"${OBJECTDIR}/canrs.o" canrs.asm 
else 
	-${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION) -u  -l"${OBJECTDIR}/canrs.lst" -e"${OBJECTDIR}/canrs.err" $(ASM_OPTIONS) -o"${OBJECTDIR}/canrs.o" canrs.asm 
endif 
	@cat  "${OBJECTDIR}/canrs.err" | sed -e 's/\x0D$$//' -e 's/\(^Warning\|^Error\|^Message\)\(\[[0-9]*\]\) *\(.*\) \([0-9]*\) : \(.*$$\)/\3:\4: \1\2: \5/g'
	@./__revgrep__ "^Error" ${OBJECTDIR}/canrs.err
endif
