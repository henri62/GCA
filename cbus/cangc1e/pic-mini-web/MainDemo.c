 ...
 */
	...
	// Please uncomment next row, if your compiler 
	// (and respectively header files) doesn't declare this register
	// static volatile near unsigned char	OSCTUNE		@ 0xF9B;
#endif
 ...
 */
#if defined(MCHP_C18) && defined(__18F25J10)
//#pragma config OSC=HSPLL, FCMEN=OFF, IESO=OFF
//#pragma config PWRT=OFF
//#pragma config WDT=OFF
//#pragma config LVP=OFF
#pragma config FOSC=HSPLL, FCMEN=OFF, IESO=OFF
#pragma config STVREN=OFF
#pragma config WDTEN=OFF
#pragma config XINST=OFF
#pragma config CCP2MX=DEFAULT 
#elif defined(HITECH_C18)
 __CONFIG(1, XINSTDIS & WDTDIS & STVRDIS & UNPROTECT);	
 __CONFIG(2, HSPLL & FCMDIS & IESODIS & WDTPS32K);
 __CONFIG(3, CCP2RC1);
#endif
...
static void InitializeBoard(void)
{
	...
	// Enable PLL
    // ****** IMPORTANT!!!!! *******
    // !!!! if this register is not declared, please uncomment row 62 on this file !!!!
	OSCTUNE = 0x40;
...
{
    MENU_CMD choice;
	ExecuteMenuChoice(MENU_CMD_DISABLE_AUTO_CONFIG);
...
//SLA#define XMODEM_BLOCK_LEN 128
