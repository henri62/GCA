...
unsigned char ucUsb2LnLength = 19;
unsigned char ucUsb2LnWordsIndex = 0;
...
char cLn2UsbBuffer[20];
char cLn2UsbLength = 19;

unsigned char   ucIdxSave;
unsigned short  usLnBitsNumber = 0;
unsigned char   ucLn2UsbWordsIndex = 0;

short sLnZeroCounter = 0;

Ln2UsbFlags_type Ln2UsbFlags;
...
void ProcessIO(void)
{
    ...
    {						  // empty.  This will cause additional USB packets to be NAK'd
        ...
        if((ucUsb2LnWordsIndex == ucUsb2LnLength) || (ucUsb2LnLength == 250))
        {
            ...
            {
                Usb2LnFlags.bUsb2LnCheckSummTest = 1;
            }
        ...
        if(Usb2LnFlags.bUsb2LnCheckSummTest)
        {
	        ...
	        if(cUsb2LnCheckSummXor == 0xFF)
	        {
	           ...
	           Usb2LnFlags.bUsb2LnCheckSummOK = 1;
